      ...
      <div ref={heroRef} className="hero-section min-h-[60vh] flex items-center justify-center pt-16 relative">
        ...
        >
          ...
          <p className={`text-xl md:text-2xl max-w-2xl mx-auto mb-8 text-white transition-all duration-1000 transform ${
            ...
            Transform your smile and quality of life with a complete arch restoration.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className={`space-y-6 transition-all duration-1000 ease-out transform ${
              ...
              <h2 className="text-3xl font-bold text-primary">What are Full Arch Implants?</h2>
              <p className="text-gray-600 leading-relaxed">
                Full arch implants, such as All-on-4® or All-on-6®, are revolutionary solutions for patients missing all teeth 
                in either the upper or lower jaw. Using just 4-6 strategically placed dental implants, we can support an entire 
                arch of fixed teeth, providing a permanent alternative to removable dentures.
              </p>
            ...
            <div className={`relative group transition-all duration-1000 ease-out transform ${
              ...
              <div className="relative hover-lift transition-all duration-500">
                <img 
                  ...
                  alt="Full Arch Implants Procedure" 
            ...
            {[
              {
                ...
                description: "Comprehensive assessment including 3D imaging to plan the optimal implant positioning for your full arch restoration."
              },
              {
                step: "2. Strategic Implant Placement",
                description: "Surgical placement of 4-6 dental implants at precise angles to maximize support with minimal bone requirements."
              },
              {
                step: "3. Fixed Arch Restoration",
                description: "Attachment of a custom-designed full arch prosthesis that looks natural and restores complete function."
              }
            ].map((phase, index) => (
              <div 
                key={index} 

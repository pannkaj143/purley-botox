...
const BoneGrafting = () => {
  ...
  const benefits = [
    "Creates suitable foundation for implants",
    "Preserves facial structure and aesthetics",
    "Prevents future bone deterioration",
    "Enables implant treatment for more patients",
      ...
      <div ref={heroRef} className="hero-section min-h-[60vh] flex items-center justify-center pt-16 relative">
        ...
        >
          ...
          <p className={`text-xl md:text-2xl max-w-2xl mx-auto mb-8 text-white transition-all duration-1000 transform ${
            ...
            Creating a solid foundation for successful dental implants.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className={`space-y-6 transition-all duration-1000 ease-out transform ${
              ...
              <h2 className="text-3xl font-bold text-primary">What is Bone Grafting?</h2>
              <p className="text-gray-600 leading-relaxed">
                Bone grafting is a surgical procedure that rebuilds or augments the bone in your jaw when there isn't enough 
                healthy bone to support dental implants. The procedure uses bone substitute materials to stimulate new bone 
                growth, creating a solid foundation that can successfully support implants. With today's advanced techniques, 
                bone grafting is a predictable and relatively comfortable procedure.
              </p>
            ...
            {[
              {
                ...
                description: "3D imaging to evaluate bone density and volume and determine the most appropriate grafting technique."
              },
              {
                step: "2. Bone Graft Procedure",
                description: "Placement of bone grafting material at the deficient site to stimulate new bone growth."
              },
              {
                step: "3. Healing Period",
                description: "4-6 month healing time for the graft to integrate before proceeding with implant placement."
              }
            ].map((phase, index) => (
              <div 
                key={index} 
